...
for epoch in range(0, epochs):
    ...
    h1, y = feed_forward(images, W1, b1, W2, b2)
    images_transposed = np.transpose(images)

    if epoch % 500 == 0:
        train_loss = evaluate_auto(y, labels) / num_examples
        print "epoch", epoch, "training loss", np.sum(train_loss)
...
visualize(10, 10, W1.T, "(e) visualization of autoencoder parameters.png")
images, _ = get_batch(100)
h1, y = feed_forward(images, W1, b1, W2, b2)
visualize(10, 10, y, "(e) auto-encoder digits.png")

# train neural net using DAE as pre-training
